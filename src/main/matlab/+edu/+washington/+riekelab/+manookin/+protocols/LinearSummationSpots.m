classdef LinearSummationSpots < edu.washington.riekelab.manookin.protocols.ManookinLabStageProtocol
    properties
...
%                 'groupBy',{'stimulusName'});
            if ~strcmp(obj.onlineAnalysis, 'none')
                obj.showFigure('edu.washington.riekelab.manookin.figures.LinearSumFigure', ...
                    obj.rig.getDevice(obj.amp),'recordingType',obj.onlineAnalysis,...
