classdef ConeRatioSearch < edu.washington.riekelab.manookin.protocols.ManookinLabStageProtocol
    properties
        ...
        greenContrasts = -1:0.1:0       % Green LED contrasts
        stimulusClass = 'full-field'    % Stimulus class
        backgroundIntensity = 0.5       % Background light intensity (0-1)
        onlineAnalysis = 'extracellular'         % Online analysis type.
        centerOffset = [0,0]            % Center offset in pixels (x,y)
        numberOfAverages = uint16(33)   % Number of epochs
    end
