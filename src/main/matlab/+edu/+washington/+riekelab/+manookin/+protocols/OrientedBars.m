classdef OrientedBars < edu.washington.riekelab.manookin.protocols.ManookinLabStageProtocol
    properties
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            if ~strcmp(obj.onlineAnalysis, 'none')
                obj.showFigure('edu.washington.riekelab.manookin.figures.OrientationFigure', ...
                    obj.rig.getDevice(obj.amp),'recordingType',obj.onlineAnalysis,...
