...
%             ramps('blue')   = 65535 * importdata(edu.washington.riekelab.manookin.Package.getCalibrationResource('rigs', 'rig_A', 'blue_gamma_ramp.txt'));
            ...
            microdisplay.addResource('quantalCatch', containers.Map( ...
                ...
                importdata(edu.washington.riekelab.manookin.Package.getCalibrationResource('rigs', 'rig_A', 'LCR10xND05.txt')), ...
                importdata(edu.washington.riekelab.manookin.Package.getCalibrationResource('rigs', 'rig_A', 'LCR10xND10.txt')), ...
                importdata(edu.washington.riekelab.manookin.Package.getCalibrationResource('rigs', 'rig_A', 'LCR10xND20.txt')), ...
                importdata(edu.washington.riekelab.manookin.Package.getCalibrationResource('rigs', 'rig_A', 'LCR10xND30.txt')), ...
                importdata(edu.washington.riekelab.manookin.Package.getCalibrationResource('rigs', 'rig_A', 'LCR10xND40.txt')), ...
                importdata(edu.washington.riekelab.manookin.Package.getCalibrationResource('rigs', 'rig_A', 'LCR60xND00.txt')), ...
                importdata(edu.washington.riekelab.manookin.Package.getCalibrationResource('rigs', 'rig_A', 'LCR60xND05.txt')), ...
                importdata(edu.washington.riekelab.manookin.Package.getCalibrationResource('rigs', 'rig_A', 'LCR60xND10.txt')), ...
                importdata(edu.washington.riekelab.manookin.Package.getCalibrationResource('rigs', 'rig_A', 'LCR60xND20.txt')), ...
                importdata(edu.washington.riekelab.manookin.Package.getCalibrationResource('rigs', 'rig_A', 'LCR60xND30.txt')), ...
                importdata(edu.washington.riekelab.manookin.Package.getCalibrationResource('rigs', 'rig_A', 'LCR60xND40.txt')), ...
                }));
