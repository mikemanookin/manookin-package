classdef SeqRanSpeed < manookinlab.protocols.ManookinLabStageProtocol
    properties
        amp                             % Output amplifier
        preTime = 500                   % Stimulus leading duration (ms)
        stimTime = 1100                 % Stimulus duration (ms)
        tailTime = 500                  % Stimulus trailing duration (ms)
        fDwell = [1 1 2 2 4 4 8 8 12 12 16 16]        % Frame dwell
        ...
        numberOfAverages = uint16(360)  % Number of epochs
    end
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            if length(obj.fDwell) > 1
                colors = pmkmp(length(obj.fDwell),'CubicYF');
            else
                colors = [0 0 0];
            end
            ...
            obj.showFigure('manookinlab.figures.MeanResponseFigure', ...
                ...
                'sweepColor',colors,...
                'groupBy',{'sequenceName','frameDwell'});
        end
        ...
        function prepareEpoch(obj, epoch)
            ...
            obj.frameDwell = obj.fDwell(mod(obj.numEpochsCompleted, length(obj.fDwell))+1);
