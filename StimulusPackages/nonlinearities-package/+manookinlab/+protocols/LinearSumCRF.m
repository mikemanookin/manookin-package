classdef LinearSumCRF < manookinlab.protocols.ManookinLabStageProtocol
    properties
        ...
        ct1 = [0.25 0.25 0.5 0.75 1 0.5]% Bar1 contrast [-1:1]
        ct2 = [0.25 0.25 0.5 0.75 1 -0.5]% Bar2 contrast [-1:1]
...
%             end
            ...
            if ~strcmp(obj.onlineAnalysis, 'none')
                obj.showFigure('manookinlab.figures.LinearSumFigure', ...
                    ...
                    'sortName', 'contrast2', 'sortValues', unique(obj.ct2));
            end
            
            % ctSeq
            numReps = ceil(double(obj.numberOfAverages)/(3*length(obj.ct1)));
            obj.ctSeq1 = ones(3,1) * obj.ct1(:)';
            obj.ctSeq1 = obj.ctSeq1(:) * ones(1, numReps);
            obj.ctSeq1 = obj.ctSeq1(:)';
            obj.ctSeq1 = obj.ctSeq1( 1 : obj.numberOfAverages );
            
            numReps = ceil(double(obj.numberOfAverages)/(3*length(obj.ct2)));
            obj.ctSeq2 = ones(3,1) * obj.ct2(:)';
            obj.ctSeq2 = obj.ctSeq2(:) * ones(1, numReps);
            obj.ctSeq2 = obj.ctSeq2(:)';
            obj.ctSeq2 = obj.ctSeq2( 1 : obj.numberOfAverages );
        ...
        function prepareEpoch(obj, epoch)
            ...
            obj.contrast1 = obj.ctSeq1( obj.numEpochsCompleted+1 );
            obj.contrast2 = obj.ctSeq2( obj.numEpochsCompleted+1 );
