classdef LinearSumOrientation < manookinlab.protocols.ManookinLabStageProtocol
    properties
        ...
        orientations = 0:30:150         % Bar orientation (degrees)
...
%                     'orientations', unique(obj.orientations));
                obj.showFigure('manookinlab.figures.LinearSumFigure', ...
                    ...
                    'sweepColor',colors,...
                    'preTime', obj.preTime, 'stimTime', obj.stimTime, ...
                    'sortName', 'orientation', ...
                    'sortValues', unique(obj.orientations));
            end
            
            % oSeq
            numReps = ceil(double(obj.numberOfAverages)/(3*length(obj.orientations)));
            obj.oSeq = ones(3,1) * obj.orientations(:)';
            obj.oSeq = obj.oSeq(:) * ones(1, numReps);
            obj.oSeq = obj.oSeq(:)';
            obj.oSeq = obj.oSeq( 1 : obj.numberOfAverages );
        ...
        function prepareEpoch(obj, epoch)
            ...
            obj.orientation = obj.oSeq( obj.numEpochsCompleted+1 );
