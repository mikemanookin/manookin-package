    ...
    methods
        ...
        function prepareRun(obj)
            ...
            if strcmp(obj.backgroundMotionClass, 'gaussian')
                obj.backgroundConditions = {'stationary','motion-gaussian'};
            else
                obj.backgroundConditions = {'stationary','motion-natural'};
            end
        end
        ...
        function prepareEpoch(obj, epoch)
            ...
            obj.spotContrast = obj.spotContrasts(mod(floor(obj.numEpochsCompleted/length(obj.spotContrasts)),length(obj.backgroundConditions))+1);
