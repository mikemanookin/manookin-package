classdef ModulatedSpot < manookinlab.protocols.ManookinLabStageProtocol
    properties
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            if strcmp(obj.stageClass, 'Video')
                ...
                obj.bgMean = obj.backgroundIntensity;
                obj.colorWeights = 1;
                if obj.backgroundIntensity > 0
        ...
        function p = createPresentation(obj)
            ...
            imgController = stage.builtin.controllers.PropertyController(spot, 'color',...
                @(state)setStimulus(obj, state.time - obj.preTime*1e-3));
            p.addController(imgController);
            
            function c = setStimulus(obj, time)
                if time >= 0
                    c = obj.bgMean .* (obj.contrast * sin(obj.temporalFrequency * time * 2 * pi) * obj.colorWeights) + obj.bgMean;
                else
                    c = obj.bgMean;
                end
            end
