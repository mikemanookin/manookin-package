classdef AdaptGratingRandomPhase < manookinlab.protocols.ManookinLabStageProtocol
    ...
    properties (Hidden)
        ...
        phaseShift
        highTime
        spatialPhase % Spatial phase of grating (deg
    end
    ...
    methods
        ...
        function prepareEpoch(obj, epoch)
            ...
            rng('shuffle','twister');
            obj.spatialPhase = 360 * rand;
            epoch.addParameter('spatialPhase', obj.spatialPhase);
