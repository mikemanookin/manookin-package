classdef LightCrafterRGBDevice < symphonyui.core.Device
    ...
    methods
        ...
        function obj = LightCrafterRGBDevice(varargin)
            ip = inputParser();
            ...
            cobj = Symphony.Core.UnitConvertingExternalDevice(['LcrRGB Stage@' ip.Results.host], 'Texas Instruments', Symphony.Core.Measurement(0, symphonyui.core.Measurement.UNITLESS));
            ...
            obj.lightCrafter = LightCrafter4500RGB(obj.stageClient.getMonitorRefreshRate());
            ...
            obj.patternRatesToAttributes(1 * refreshRate)  = {6, 'white', 3};
